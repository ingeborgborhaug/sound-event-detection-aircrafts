...
MEL_MAX_HZ = 7500
LOG_OFFSET = 0.001
PATCH_WINDOW_SECONDS = 0.96 #0.96 # duration of each patch fed into model, in seconds
PATCH_HOP_SECONDS = PATCH_WINDOW_SECONDS/2 # step size between patches, in seconds
