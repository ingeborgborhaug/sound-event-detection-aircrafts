...
class Plotter():
    def __init__(self, n_classes, wavfile, starttime, model, endtime, gt=None, n_bands=64, msd_labels=None, FIG_SIZE=(8,8),blit=True, save_pdf_path=None):
        ...
        self.axs[0].set_ylabel('Mel Bands', fontsize=common_font_size)
        ...
        spec_cb.ax.tick_params(labelsize=common_font_size * 0.8)
        #spec_cb.set_label('Log-mel intensity', fontsize=common_font_size)
        ...
        self.axs[1].set_ylabel('Prediction', rotation=0, ha='right', va='center', labelpad=12, fontsize=common_font_size)
        ...
        cb.ax.tick_params(labelsize=common_font_size * 0.8)
        ...
        gt_cb.ax.tick_params(labelsize=common_font_size * 0.8)
        gt_cb.set_ticks([0, 1])
        ...
        self.axs[2].tick_params(axis='x', which='both', bottom=True, top=False, labelbottom=True, labelsize=common_font_size)
        self.axs[2].set_xlabel('Time', fontsize=common_font_size)
    ...
    def plot_windows_in_rows(self, ax, values, data_label, title_suffix="", max_labels=20, cmap=None):
        ...
        ax.set_ylim(-0.6, 1.6)
        ax.set_yticks([])
        ax.set_ylabel(data_label, rotation=0, ha='right', va='center', labelpad=12, fontsize=common_font_size)
